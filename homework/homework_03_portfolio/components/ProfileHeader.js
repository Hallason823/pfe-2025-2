  ...
  return (
    <Grid container spacing={4} alignItems="center" justifyContent="center">
      ...
      <Grid size={{ xs: 12, sm: 8, md: 9 }}>
        <Typography variant="h2" textAlign="center">{userProfile.name}</Typography>
        <Typography variant="h5" textAlign="center" color="text.secondary">I&apos;m a {userProfile.profession}</Typography>
